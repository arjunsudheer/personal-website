	...
	return (
		<>
			...
			<InfoCard
				...
				keyHighlights={["Offered By: LinkedIn"]}
				topSkills={["Docker"]}
				textRight={false}
			...
			<InfoCard
				...
				keyHighlights={["Offered By: LinkedIn"]}
				topSkills={["Python", "Data Structures and Algorithms"]}
				textRight={true}
			...
			<InfoCard
				...
				keyHighlights={["Offered By: Unviersity of London"]}
				topSkills={["HTML", "CSS", "MeteorJS", "Responsive Web Design"]}
				textRight={true}
