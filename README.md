...
Write posts as Markdown files in [`public/blog/`](public/blog/adding-a-blog-post.md). Add its
title, summary, slug, and reading time to `src/data/blog-post-metadata.ts` so it
